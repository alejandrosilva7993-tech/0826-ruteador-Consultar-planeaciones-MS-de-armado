...
function openConfirmModal({ action, routeIds }) {
  ...
  if (action === "accept") {
    ...
    bodyEl.innerHTML = plural
      ? "<p>Las órdenes quedarán asignadas y las rutas no podrán ser modificadas. Al aceptar las rutas, si estas incluyen órdenes hijas, se ejecutará el split y se crearán dichas órdenes.</p><p><strong>¿Deseas continuar?</strong></p>"
      : "<p>Las órdenes quedarán asignadas y la ruta no podrá ser modificada. Al aceptar la ruta, si esta incluye órdenes hijas, se ejecutará el split y se crearán dichas órdenes.</p><p><strong>¿Deseas continuar?</strong></p>";
  } else {
